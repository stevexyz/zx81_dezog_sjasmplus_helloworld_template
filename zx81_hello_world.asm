...
; always end with _NL (new line, carriage return, $76 or halt instruction), moreover the whole 
; screen should always start end end with _NLs. To avoid to define all the 24 lines after the last
...
; explanations on ZX81 TV rendering). Some system variables at the beginning of the page at $4000 
; are really important for the video: DFILE, MARGIN, FRAMES, CDFLAGS, use them understanding
; their behaviour.
