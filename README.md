...
Required to be installed: Visual Studio Code with [DeZog extension](https://github.com/maziac/DeZog). The [sjasmplus](https://github.com/z00m128/sjasmplus) executable provided within this repo should be enough to start, but you can find the last version and all the documentation in the linked project page.

How to start?
- Start vscode with "code ." inside this repo directory
- Set a breakpoint on first line of code inside the zx81_hello_world.asm 
- Run->Start Debugging (F5): the program will compile and run until the line with breakpoint
